function DESKTOP_APPS_MENU() {
	...
	case $MENU in
		1)
			EXECUTE_DRIVER_D google-chrome GOOGLE_CHROME_DRIVER DESKTOP_APPS_MENU 
			;;
		2)
			EXECUTE_DRIVER_D opera OPERA_DRIVER DESKTOP_APPS_MENU 
			;;
		x)
			LIZZ_MENU
			;;
...
function PROGRAMMING_LANGUAGES_MENU() {
	...
	case $MENU in
		1)
			EXECUTE_DRIVER_D mysql MYSQL_DRIVER PROGRAMMING_LANGUAGES_MENU
			;;
		2)
			EXECUTE_DRIVER_D node NODE_DRIVER PROGRAMMING_LANGUAGES_MENU
			;;
		3)
			EXECUTE_DRIVER_D python3 PYTHON3_DRIVER PROGRAMMING_LANGUAGES_MENU
			;;
		4)
			EXECUTE_DRIVER_D rustc RUST_DRIVER PROGRAMMING_LANGUAGES_MENU
			;;
		x)
			DEV_PACKAGES_MENU
			;;
